...
4) From the Apple App Store, install Envelopes (i.e. the remote client) ![alt text](https://github.com/derekworth/Famliy-Envelopes/blob/master/lib/e300.png "Logo Title Text 1")
