...
4) From the Apple App Store, install Envelopes (i.e. the remote client) ![alt text](https://github.com/adam-p/markdown-here/raw/master/src/common/images/icon48.png "Logo Title Text 1")
